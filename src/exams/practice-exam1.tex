...
% Preamble
\documentclass[exam=1]{math252exam}
...
\begin{enumerate}[label=\arabic*.]
	...
	\begin{enumerate}[label=(\alph*)]
	    \subproblem Determine the equilibrium solutions of the differential equation.\answer{$y=3$, $y=-2$, $y=5$}
	...
	\begin{aligned}
		...
		ydy &= x\left( 1 + y^{2} \right)dx\\
		\frac{y}{1 + y^{2}}dy &= xdx\\
		\int \frac{y}{1 + y^{2}}dy &= \int xdx\\
		\int \frac{1}{u}\frac{du}{2} &= \frac{x^{2}}{2} + C\\
		\frac{1}{2}\int \frac{du}{u} &= \frac{x^{2}}{2} + C\\
		\frac{1}{2}\ln|u| &= \frac{x^{2}}{2} + C\\
	...
	\begin{aligned}
		...
		y^{2}+1 &= e^{x^{2}}e^{C}\\
		y^{2} &= Ae^{x^{2}} - 1\\
		y &= \pm\sqrt{Ae^{x^{2}} - 1}\correction{\mbox{ with } A >0}\\
	\end{aligned}
	\end{equation*}}
