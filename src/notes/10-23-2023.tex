...
This can be written in terms of the Heavyside Function\label{dfn:heavyside-function} (or Unit Step function) \[ U(t) = \left\{ \begin{array}{cl}
	0 & \mbox{ if } t < 0\\
	1 & \mbox{ if } t \geq 0\\
\end{array} \right. \]

\[ f(t-2)\times U(t-2) \] is ``off when $t<2$ and on when $t \geq 2$.
