...
\example
$y'=-\frac{1}{x^{2}}$ has a solution $\phi(x)=\frac{1}{x}$ on $I=\left( 0, \infty \right)$ but the domain of $\phi(x)=\left( -\infty, 0 \right) \cup \left(0, \infty\right)$.\\\\
...
\end{aligned}
\end{equation*}
But the equation $x=c_{2}\cos(4t)$ would also be a solution. \hyperref[dfn:linear-combination]{If you have 2 equations that are both solutions, you could add them together and you would still have a solution.} $x=c_{1}\sin(4t)+c_{2}\cos(4t)$ is a solution for all parameters $c_{1}$ and $c_{2}$. \emph{In fact, this is the general solution to the D.E.}\\\\
