...
% Preamble
\documentclass[title={Sep 29{,} 2023 Notes}]{math252notes}
\usepackage{amssymb}
% Document
\begin{document}
...
\begin{equation}F_{g} = -F_{spring} \rightarrow mg = -F_{spring} \rightarrow -mg = -kx (\mbox{Hooke's Law})\label{eq:hookes=law}\end{equation}
where $g\approx 9.8 m/s^{2}$ if m is in kg, else $g\approx 32.1 ft/sec^{2}\rightarrow 32 ft/sec^{2}$.\\
